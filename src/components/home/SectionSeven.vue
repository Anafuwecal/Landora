      ...
      >
        ...
        >
          ...
          <div class="relative h-48 overflow-hidden">
            ...
            />
            <div class="absolute top-4 left-4 bg-landora-primary text-white 
                        px-3 py-1 text-xs font-heading font-semibold uppercase rounded">
              {{ post.category }}
            </div>
          </div>
          ...
          <div class="p-6">
            ...
            <RouterLink 
              ...
              class="block"
            >
              <h3 class="text-lg font-heading font-semibold text-landora-dark mb-3
                         group-hover:text-landora-primary transition-colors line-clamp-2">
                {{ post.title }}
              </h3>
            </RouterLink>
