        ...
        <div class="space-y-4">
          ...
          >
            <button
              ...
              class="w-full flex items-center justify-between p-6 text-left bg-white hover:bg-landora-light transition-colors"
            >
...
import { ChevronRightIcon, PlusIcon, ArrowRightIcon } from '@heroicons/vue/24/outline'

const heroImage = 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80'
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'We work with several partner banks to offer competitive mortgage rates starting from 3.5%. Our financial advisors can help you explore various financing options and find the best solution for your situation.',
  },
  {
    id: 4,
    question: 'Are the properties pet-friendly?',
    answer: 'Yes, most of our properties are pet-friendly. However, specific rules may apply depending on the building and unit type. Please check with our sales team for detailed information.',
  },
  {
    id: 5,
    question: 'What is included in the property price?',
    answer: 'Our property prices include the finished unit with all standard fixtures and fittings. This typically includes flooring, kitchen cabinets, bathroom fixtures, and basic lighting.',
  },
  {
    id: 6,
    question: 'How long does the purchase process take?',
    answer: 'The typical purchase process takes 4-8 weeks from initial agreement to key handover. This includes property inspection, legal checks, financing approval, and contract signing.',
  },
]
</script>