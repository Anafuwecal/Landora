  ...
  <div class="sales-team-page">
    ...
    <section class="section-container">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        >
          ...
          <div class="relative mb-6 overflow-hidden rounded-lg">
            ...
            <div class="absolute inset-0 bg-landora-primary/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div class="flex space-x-4">
                <a
                  v-if="member.linkedin"
                  :href="member.linkedin"
                  target="_blank"
                  class="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-white hover:bg-white hover:text-landora-primary transition-colors"
                >
      ...
      <div class="mt-16 text-center p-8 bg-landora-light rounded-lg">
        ...
        <a href="mailto:careers@landora.com" class="btn-primary inline-flex items-center">
          View Open Positions
...
import { ChevronRightIcon, EnvelopeIcon, ArrowRightIcon } from '@heroicons/vue/24/outline'
